...
./distributed_train.sh $GPU_NUM $DATASET_ROOT  --dataset carla --train-towns 1 2 3 4 6 7 10  --val-towns 5 \
    ...
    --model interfuser_baseline --sched cosine --epochs 10 --warmup-epochs 1 --lr 0.005 --batch-size 16  -j 16 --no-prefetcher --eval-metric l1_error \
    ...
    --experiment test_plankd \
    --loss_kind att \
    --use_kd yes --teacher_model interfuser_baseline --student_model $MODEL \
    --teacher_path /home/InterFuser/interfuser/output/teacher_example.pth.tar \
    --beta_z 0.1 --beta_e 0.005 --beta_r 0.1 \
    --pretrained \
