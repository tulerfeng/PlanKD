...
class CheckpointSaver:
    def __init__(
        ...
        if self.student:
            self.save_prefix += '_student'
            self.recovery_prefix += '_student'
    ...
    def save_checkpoint(self, epoch, metric=None):
        ...
        if not self.student:
            ...
            tmp_save_path = os.path.join(self.checkpoint_dir, "tmp_student" + self.extension)
            last_save_path = os.path.join(self.checkpoint_dir, "last_student" + self.extension)
        ...
        if (
            ...
            if metric is not None and (
                ...
                if not self.student:
                    ...
                    best_save_path = os.path.join(
                        self.checkpoint_dir, "model_best_student" + self.extension
                    )
