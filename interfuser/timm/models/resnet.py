...
def _create_resnet(variant, pretrained=False, **kwargs):
    if variant=='resnet6d':
        return build_model_with_cfg(
            ResNet6, variant, pretrained, default_cfg=default_cfgs[variant], **kwargs
        )
...
@register_model
def resnet6d(pretrained=False, **kwargs):
    """Constructs a ResNet-10 model."""
    model_args = dict(block=BasicBlock, layers=[1, 1, 1], **kwargs)
    return _create_resnet("resnet6d", pretrained, **model_args)

@register_model
def resnet10(pretrained=False, **kwargs):
    """Constructs a ResNet-10 model."""
    model_args = dict(block=BasicBlock, layers=[1, 1, 1, 1], **kwargs)
    return _create_resnet("resnet10", pretrained, **model_args)
