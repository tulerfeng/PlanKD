...
class InterfuserAgent(autonomous_agent.AutonomousAgent):
    def setup(self, path_to_conf_file):
        ...
        conf_path = path_to_conf_file[0]
        ckpt_path = path_to_conf_file[1]
        ckpt_name = path_to_conf_file[2]
        ...
        self.config = imp.load_source("MainModel", conf_path).GlobalConfig(my_param={'ckpt_path':ckpt_path, 'ckpt_name':ckpt_name})
    ...
    def run_step(self, input_data, timestamp):
        ...
        if len(self.v_list)%100 == 1:
            torch.save(torch.tensor(self.v_list), '/home/InterFuser/behave/baseline2_att_ckpt9_' + 'route0' + '.npy')
