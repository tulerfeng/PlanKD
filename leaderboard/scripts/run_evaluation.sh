...
echo $time 
    ...
    export TM_PORT=2508 # port for traffic manager, required when spawning multiple servers/clients
    ...
    export CHECKPOINT_ENDPOINT=results/baseline2_dec_epoch30_short5_cr$time.json # results file
    export SCENARIOS=leaderboard/data/scenarios/town05_all_scenarios.json
    export SAVE_PATH=data/eval # path for saving episodes while evaluating
    export RESUME=True


    export CKPT_PATH=interfuser/output/test_dec_30_epoch-interfuser_baseline2-20240302-113802/checkpoint-28.pth.tar
