...
class LeaderboardEvaluator(object):
    ...
    def _load_and_run_scenario(self, args, config):
        ...
        try:
            ...
            if args.ckpt_path != "":
                self.agent_instance = getattr(self.module_agent, agent_class_name)([args.agent_config, args.ckpt_path, args.ckpt_name])
            else:
    ...
    def run(self, args):
        ...
        while route_indexer.peek():
            ...
            #     import pdb
            #     pdb.set_trace()
            #     torch.save(torch.tensor(self.agent_instance.v_list), '/home/InterFuser/behave/test_' + config.name + '.npy')
...
def main():
    ...
    parser.add_argument("--ckpt_path", type=str, help="", default="")
    parser.add_argument("--ckpt_name", type=str, help="", default="")
